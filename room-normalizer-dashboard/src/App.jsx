...
import CaseLog from "./pages/CaseLog.jsx";
import AINormalizer from "./pages/AINormalizer.jsx";
...
const NAV = [
  ...
  { to: "/case-log", label: "Case Log" },
  { to: "/bulk", label: "Bulk Translator" },
  { to: "/rule-review", label: "Rule Review" },
  { to: "/ai-normalizer", label: "AI Normalizer" },
];
    ...
    <div className="min-h-screen bg-base-950 text-base-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        <Routes>
          ...
          <Route path="/ai-normalizer" element={<AINormalizer />} />
        </Routes>
      </main>
    </div>
  );
