...
function toCsv(rows) {
  const header = ["raw_name", "canonical_string", "canonical_hash", "class", "occupancy", "type", "bedroom", "bedding", "view", "building", "accessibility", "other", "custom", "status", "review_details", "error"];
  const esc = (v) => {
