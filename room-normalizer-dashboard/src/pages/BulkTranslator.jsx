...
function toCsv(rows) {
  const header = ["raw_name", "canonical_string", "canonical_hash", "class", "occupancy", "type", "bedroom", "bedding", "view", "building", "accessibility", "access", "other", "undefined", "status", "review_details", "error"];
  const esc = (v) => {
