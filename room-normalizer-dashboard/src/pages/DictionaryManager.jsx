...
const CATEGORY_STYLES = {
  ...
  BUILDING_MODIFIER: "bg-amber-950/40 text-amber-300 border-amber-800",
...
const CATEGORY_DESCRIPTIONS = {
  ...
  BUILDING: "Which building/wing — Annex, Dependance, Tower, Wing, Section, Level, Floor, Block, Area, Building. Standalone or paired with a CLASS/VIEW_CORE/BUILDING_MODIFIER word into one combined phrase (\"Executive Wing\").",
  BUILDING_MODIFIER: "A word that attaches to an adjacent BUILDING word instead of standing alone — East/West/North/South (\"East Wing\"). Consumed automatically by the Building-pairing engine pass; flagged for review if no BUILDING anchor is nearby.",
