...
function TokenDetail({ exp }) {
  ...
  if (exp.status === "matched") {
    ...
    statusSubtext = "Unresolved → emitted as Undefined";
  ...
  if (exp.status === "unresolved") whyLines.push("→ Reached pass3 and was emitted as undefined output");
  ...
  const finalLoc = exp.finalComponent || (exp.status === "unresolved" ? "parsed_components.undefined" : "N/A");
